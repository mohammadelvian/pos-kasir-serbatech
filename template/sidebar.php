...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?= $main_url ?>dashboard.php" class="brand-link">
        ...
        <span class="brand-text font-weight-light">SerbaTech POS</span>
    </a>
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="<?= $main_url ?>asset/image/<?= userLogin()['foto'] ?>" class="img-circle elevation-2" alt="User Image" style="width: 40px; height: 40px; object-fit:cover;">
            </div>
            <div class="info">
